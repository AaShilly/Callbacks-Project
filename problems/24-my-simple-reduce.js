...
let mySimpleReduce = function(arr, cb) {
    //sets the first value of the array to the accumulator
    let accumulator = arr[0];

    //loops through each element of the array starting at the second element
    for (let i = 1; i < arr.length; i++){
       let el = arr[i];
       //sets the current accumulator value to the return value of passing in the current
       //acumulator and element into the call back function
